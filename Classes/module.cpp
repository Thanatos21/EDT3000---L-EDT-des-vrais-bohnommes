...
Module::Module(const int& nombre_H_CM, const int& nombre_H_TD, const int& nombre_H_TP, const std::string& code, const std::string& titre, Enseignant* enseignant) : nombre_H_CM_(nombre_H_CM), nombre_H_TD_(nombre_H_TD), nombre_H_TP_(nombre_H_TP), code_(code), titre_(titre), enseignant_(enseignant)
{
}
...
void Module::setEnseignant(Enseignant* ens)
{
	enseignant_ = ens;
}
...
Enseignant* Module::getEnseignant() const
{
	return enseignant_;
}
